...
df_states_ = df_states[df_states['data'] == '2021-11-10']
...
fig = px.choropleth_mapbox(df_states_, locations='estado', color="casosNovos",
                        ...
                        hover_data={'casosAcumulado': True, "casosNovos": True, "obitosAcumulado": True, "obitosNovos": True, "estado": True})
fig.update_layout(
...
@app.callback(
    [
        ...
        Output('novos_casos-text', 'children'),
